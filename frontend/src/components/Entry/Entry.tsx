...
export const Entry: FC<FieldAttributes<HTMLInputElement> & { errorAlert?: boolean }> = ({ errorAlert, ...props }) => {
    return <Fragment>
        <Field {...props} className="focus:border-0 focus:shadow-none focus:outline-none focus:ring-0 w-full text-xl p-4 bg-stone-200 dark:bg-stone-800 dark:text-stone-200" />
        {errorAlert &&

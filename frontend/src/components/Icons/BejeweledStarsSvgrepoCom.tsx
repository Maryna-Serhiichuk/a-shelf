...
const SvgBejeweledStarsSvgrepoCom = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <style>
        {
          ".bejeweled-stars-svgrepo-com_svg__a{fill:none;stroke:#000;stroke-linecap:round;stroke-linejoin:round}"
        }
      </style>
    </defs>
    <path
      ...
      className="bejeweled-stars-svgrepo-com_svg__a"
    />
    <path
...
export default SvgBejeweledStarsSvgrepoCom;

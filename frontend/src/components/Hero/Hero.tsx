...
export const Hero: FC<Hero> = ({ heading, main, button }) => {
    return <Container>
        <section className="grid grid-cols-3 lg:grid-cols-2 my-2 md:my-10 gap-2 sm:gap-8">
            <div className="col-span-2 lg:col-span-1 flex flex-col gap-5 sm:gap-8 py-[10px] sm:py-[30px] lg:py-0 xl:py-[50px]">
                <h1 className="font-semibold text-5xl/14 lg:text-6xl/20 dark:text-stone-300 font-heading tracking-wide">
                    {heading}
                </h1>
                {button &&
                    <div>
            ...
            <div className="col-span-1 flex justify-end gap-4 md:gap-8 h-[80%]">
                {main?.url &&
                    <div className={classNames("relative h-[80%] overflow-hidden w-[220px] rounded-[110px]")}>
                        ...
                        <div className="relative z-5 h-full w-full flex justify-center items-center py-20 sm:py-30">
                            <div className="w-[60%]">
                                <Img src={main?.url} />
                            </div>
                        </div>

...
import { IconDescriptionProps } from "@/components/IconDescription";

export const IconText: FC<IconDescriptionProps> = ({ title, description, icon: Icon }) => {
    return <div key={title} className="flex flex-row items-center sm:flex-col gap-3 grid-span-1">
        <div className="relative flex justify-center">
            ...
            <Icon fontSize={100} className="relative z-1"/>
        </div>
